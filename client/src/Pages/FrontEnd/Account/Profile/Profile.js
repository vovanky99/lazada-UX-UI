...
function Profile({ data }) {
  ...
  const [birthday, setBirthday] = useState('05/01/1999');
                      ...
                      <div className={cx('gender')}>
                        <div className={cx('gender-contain', 'd-flex flex-row gap-3')}>
                          <div
                            className={cx(
                              'stardust-radio',
                              'stardust_radio_click d-flex flex-row stardust-radio_active',
                            )}
                          >
                            <div className={cx('outer-circle', 'outer-circle_active')} value={1}>
                              <div className={cx('inner-circle', 'inner-circle_active')}></div>
                            </div>
                            <div className={cx('gender-male')}>Male</div>
                          </div>
                          <div className={cx('stardust-radio', 'stardust_radio_click d-flex flex-row')}>
                            <div className={cx('outer-circle', 'outer-circle_active')} value={2}>
                              <div className={cx('inner-circle', 'inner-circle_active')}></div>
                            </div>
                            <div className={cx('gender-female')}>Female</div>
                          </div>
                          <div className={cx('stardust-radio', 'stardust_radio_click d-flex flex-row')}>
                            <div className={cx('outer-circle', ' outer-circle_active')} value={3}>
                              <div className={cx('inner-circle', 'inner-circle_active')}></div>
                            </div>
